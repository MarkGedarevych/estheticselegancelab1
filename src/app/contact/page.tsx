                ...
                <div className="card">
                  ...
                  <div className="flex gap-4">
                    <a
                      ...
                      className="w-12 h-12 rounded-xl bg-[var(--color-primary-light)] flex items-center justify-center hover:bg-[var(--color-primary)] transition-colors"
                      aria-label="Instagram"
                    >
                      <svg className="w-5 h-5 text-[var(--color-text-main)]" fill="currentColor" viewBox="0 0 24 24">
